"""Email sending utility for sending survey results."""
import smtplib
from email.mime.text import MIMEText
from email.mime.multipart import MIMEMultipart
from src.email_connection_manager import EmailConnectionManager


class EmailSender:
    """Handles sending emails with survey results."""

    def __init__(self):
        """Initialize email sender using EmailConnectionManager."""
    ...
    def close(self):
        """Close the connection manager (for consistency with DatabaseHandler)."""
