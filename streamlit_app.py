...
DB_READ = True  # Read from DynamoDB (requires AWS credentials in Streamlit Cloud secrets)
DB_WRITE = True  # Write to DynamoDB (requires AWS credentials in Streamlit Cloud secrets)
...
LLM_ENABLED = True  # Enable LLM features (requires LLM credentials in Streamlit Cloud secrets)
